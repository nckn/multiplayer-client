...
export default {
  ...
  methods: {
    ...
    init () {
      ...
      // Parent adjustments
      self.$parent.renderer.toneMapping = THREE.ReinhardToneMapping 
      ...
      loader.load(
        ...
        function (gltf) {
          ...
          let idleAnim = THREE.AnimationClip.findByName(fileAnimations, animString)
      ...
      // GUI
			var gui = new GUI()
			gui.add( self.params, 'exposure', 0.1, 2 ).onChange( function ( value ) {
				self.$parent.renderer.toneMappingExposure = Math.pow( value, 4.0 );
			})

			gui.add( self.params, 'bloomThreshold', 0.0, 1.0 ).onChange( function ( value ) {
				bloomPass.threshold = Number( value );
			})

			gui.add( self.params, 'bloomStrength', 0.0, 3.0 ).onChange( function ( value ) {
				bloomPass.strength = Number( value );
			})

			gui.add( self.params, 'bloomRadius', 0.0, 1.0 ).step( 0.01 ).onChange( function ( value ) {
