...
export default {
  ...
  methods: {
    ...
    init () {
      ...
      self.camera.position.set(self.camPos.x, self.camPos.y, self.camPos.z)
    ...
    setupLight() {
      ...
      var shadowLight = new self.$gThree.DirectionalLight(0xffffff, 1);
      ...
      // lightBallC.position.copy(light3.position);
      // self.scene.add(lightBallC);
