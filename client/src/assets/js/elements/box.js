...
let textureFiles = [
  {name: 'k', url: require('@/assets/svg/letters/letter-k.svg')},
  {name: 'o', url: require('@/assets/svg/letters/letter-o.svg')},
  {name: 'n', url: require('@/assets/svg/letters/letter-n.svg')},
  {name: 'r', url: require('@/assets/svg/letters/letter-r.svg')},
  {name: 'a', url: require('@/assets/svg/letters/letter-a.svg')},
