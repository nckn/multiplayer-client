...
class Item {
  constructor(el, scroll) {
    ...
    this.mesh = scene.createMesh({
      ...
      height: this.height,
      src: this.src,
      image: this.imageElem,
      iWidth: this.imageElem.width,
      iHeight: this.imageElem.height
    });
    ...
    this.observer.observe(this.imageElem);
    // init/bind events
  ...
  getSize() {
    ...
    console.log(this.imageElem)
    // return
    const bounds = this.imageElem.getBoundingClientRect();
...
class SmoothScroll {
  constructor() {
    ...
    console.log('got the dom alright')
  ...
  createItems() {
    allImages = document.querySelectorAll(".js-image")
    // allImages = document.querySelectorAll(".item__image")
    allImages.forEach(image => {
      console.log('creating items')
      console.log(image)
      
      if (image.classList.contains("js-image")) {
